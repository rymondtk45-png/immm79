...
# ==== Telegram Alert ====
# Cách lấy TOKEN: chat với @BotFather trên Telegram -> /newbot -> lấy token dạng
#   123456789:AAExxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
# Cách lấy CHAT_ID: chat với bot vừa tạo 1 tin nhắn bất kỳ, sau đó mở trình duyệt:
#   https://api.telegram.org/bot<TOKEN>/getUpdates
# tìm "chat":{"id": ...} trong JSON trả về. Với group, thêm bot vào group rồi làm tương tự
# (chat_id của group thường là số âm).
#
# KHUYẾN NGHỊ: đừng hardcode token thẳng vào file này nếu định đẩy code lên Git công khai —
# set qua biến môi trường thay vì sửa trực tiếp:
...
TELEGRAM_ONLY_ACTIONABLE = True

# Độ tin cậy tối thiểu (0-100) để 1 coin PUMP/DUMP được gửi cảnh báo.
# Coin chỉ có data từ 1-2/6 sàn (confidence thấp) sẽ bị lọc bỏ, tránh báo động giả.
